...
// TODO delete logger and all uses of it to keep code slim and focused on core functionality, unless you think it's useful for debugging or future maintenance.
@Injectable()
export class TcpListenerService implements OnModuleInit, OnModuleDestroy {
  ...
  private onConnection(socket: net.Socket) {
    ...
    // TODO what is this, and is it necessary? Ask an llm
    socket.on('data', (chunk: Buffer) => {
      ...
      for (const line of parts) {
        ...
        try {
          ...
          // TODO Map payload to TestMeasurementDto expected by MeasurementsService
